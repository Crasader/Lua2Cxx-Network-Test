...
namespace net{
    ...
    **/
    struct DataNode{
        ...
        DataNode *rightLink;
        DataNode *parent;
        DataNode():leftLink(NULL),rightLink(NULL),isRoot(false),isList(false),travelId(0),listSize(0),isObject(false),nodeName(NULL),data(NULL),dataType(DataType::UNKNOWN){}
        ~DataNode(){
            switch (dataType) {
