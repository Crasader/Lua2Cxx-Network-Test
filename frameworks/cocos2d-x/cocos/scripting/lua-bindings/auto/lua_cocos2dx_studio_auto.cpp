...
int lua_cocos2dx_studio_ColliderBody_getContourData(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderBody* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccs.ColliderBody",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocostudio::ColliderBody*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderBody_getContourData'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
            return 0;
        cocostudio::ContourData* ret = cobj->getContourData();
        object_to_luaval<cocostudio::ContourData>(tolua_S, "ccs.ContourData",(cocostudio::ContourData*)ret);
        return 1;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "getContourData",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderBody_getContourData'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderBody_getCalculatedVertexList(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderBody* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderBody_getCalculatedVertexList'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
            return 0;
        const std::vector<cocos2d::Vec2, std::allocator<cocos2d::Vec2> >& ret = cobj->getCalculatedVertexList();
//        object_to_luaval<std::vector<cocos2d::Vec2, std::allocator<cocos2d::Vec2> >&>(tolua_S, "std::vector<cc.Vec2, std::allocator<cc.Vec2> >",(std::vector<cocos2d::Vec2, std::allocator<cocos2d::Vec2> >&)ret);
        return 1;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "getCalculatedVertexList",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderBody_getCalculatedVertexList'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderBody_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderBody* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
            return 0;
        cobj = new cocostudio::ColliderBody(arg0);
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccs.ColliderBody");
        return 1;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ColliderBody",argc, 1);
    return 0;
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderBody_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_studio_ColliderBody_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (ColliderBody)");
    return 0;
}

int lua_register_cocos2dx_studio_ColliderBody(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccs.ColliderBody");
    tolua_cclass(tolua_S,"ColliderBody","ccs.ColliderBody","cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,"ColliderBody");
        tolua_function(tolua_S,"getContourData",lua_cocos2dx_studio_ColliderBody_getContourData);
        tolua_function(tolua_S,"getCalculatedVertexList",lua_cocos2dx_studio_ColliderBody_getCalculatedVertexList);
        tolua_function(tolua_S,"new",lua_cocos2dx_studio_ColliderBody_constructor);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocostudio::ColliderBody).name();
    g_luaType[typeName] = "ccs.ColliderBody";
    g_typeCast["ColliderBody"] = "ccs.ColliderBody";
    return 1;
}

int lua_cocos2dx_studio_ColliderDetector_getBone(lua_State* tolua_S)
{
    int argc = 0;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccs.ColliderDetector",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocostudio::ColliderDetector*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_getBone'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_getBone'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_addContourData(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_addContourData'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_addContourData'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_addContourDataList(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_addContourDataList'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        cocos2d::Vector<cocostudio::ContourData *> arg0;

        ok &= luaval_to_ccvector(tolua_S, 2, &arg0);
        if(!ok)
            return 0;
        cobj->addContourDataList(arg0);
        return 0;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "addContourDataList",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_addContourDataList'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_getActive(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_getActive'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_getActive'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_setActive(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_setActive'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_setActive'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_updateTransform(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_updateTransform'", nullptr);
        return 0;
    }
#endif
    ...
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "updateTransform",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_updateTransform'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_removeAll(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_removeAll'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_removeAll'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_init(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_init'", nullptr);
        return 0;
    }
#endif
    argc = lua_gettop(tolua_S)-1;
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_init'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_removeContourData(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_removeContourData'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
            return 0;
        cobj->removeContourData(arg0);
        return 0;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "removeContourData",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_removeContourData'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_setBone(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_setBone'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_setBone'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_getColliderBodyList(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ColliderDetector_getColliderBodyList'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_getColliderBodyList'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
#if COCOS2D_DEBUG >= 1
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccs.ColliderDetector",0,&tolua_err)) goto tolua_lerror;
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_studio_ColliderDetector_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ColliderDetector* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
            return 0;
        cobj = new cocostudio::ColliderDetector();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccs.ColliderDetector");
        return 1;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "ColliderDetector",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ColliderDetector_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_studio_ColliderDetector_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (ColliderDetector)");
    return 0;
}

int lua_register_cocos2dx_studio_ColliderDetector(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccs.ColliderDetector");
    tolua_cclass(tolua_S,"ColliderDetector","ccs.ColliderDetector","cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,"ColliderDetector");
        tolua_function(tolua_S,"getBone",lua_cocos2dx_studio_ColliderDetector_getBone);
        tolua_function(tolua_S,"addContourData",lua_cocos2dx_studio_ColliderDetector_addContourData);
        tolua_function(tolua_S,"addContourDataList",lua_cocos2dx_studio_ColliderDetector_addContourDataList);
        tolua_function(tolua_S,"getActive",lua_cocos2dx_studio_ColliderDetector_getActive);
        tolua_function(tolua_S,"setActive",lua_cocos2dx_studio_ColliderDetector_setActive);
        tolua_function(tolua_S,"updateTransform",lua_cocos2dx_studio_ColliderDetector_updateTransform);
        tolua_function(tolua_S,"removeAll",lua_cocos2dx_studio_ColliderDetector_removeAll);
        tolua_function(tolua_S,"init",lua_cocos2dx_studio_ColliderDetector_init);
        tolua_function(tolua_S,"removeContourData",lua_cocos2dx_studio_ColliderDetector_removeContourData);
        tolua_function(tolua_S,"setBone",lua_cocos2dx_studio_ColliderDetector_setBone);
        tolua_function(tolua_S,"getColliderBodyList",lua_cocos2dx_studio_ColliderDetector_getColliderBodyList);
        tolua_function(tolua_S,"new",lua_cocos2dx_studio_ColliderDetector_constructor);
        tolua_function(tolua_S,"create", lua_cocos2dx_studio_ColliderDetector_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocostudio::ColliderDetector).name();
    g_luaType[typeName] = "ccs.ColliderDetector";
    g_typeCast["ColliderDetector"] = "ccs.ColliderDetector";
    return 1;
}
...
TOLUA_API int register_all_cocos2dx_studio(lua_State* tolua_S)
{
	...
	lua_register_cocos2dx_studio_ColliderBody(tolua_S);
	...
	lua_register_cocos2dx_studio_ColliderDetector(tolua_S);
